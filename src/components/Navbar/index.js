...
import Shubham from "../../data/Manoj_Resume.pdf"
const Navbar = () => {
      ...
      <NavbarContainer id="nav-menu">
        ...
        <NavItems>
          ...
          <ButtonContainer id="resume-button-1" >
            <ResumeButton id="resume-link-1" className='nav-link resume' href={Shubham} target="_blank" download="Manoj-H-Resume" rel="noopener noreferrer" onClick={handleResumeButtonClick}>Resume</ResumeButton>
          </ButtonContainer>
        </NavItems>
